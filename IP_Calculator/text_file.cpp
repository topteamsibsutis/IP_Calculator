...
void create_file(string ip, string netmask, string wildcard, string broadcast, string address, string first_host, string last_host, string quan_ip_all, string quan_ip_aviable)
{
