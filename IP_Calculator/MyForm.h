...
void check_ip_input(std::string ip_input_string) {
  ...
  if (error == 1) {
    System::Windows::Forms::MessageBox::Show(
        ...
        "Invalid format", System::Windows::Forms::MessageBoxButtons::OK,
  ...
  the IP-address again.","Invalid format",
  System::Windows::Forms::MessageBoxButtons::OK,System::Windows::Forms::MessageBoxIcon::Error);System::Windows::Forms::Application::Restart();}*/
}
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->label1->Font = (gcnew System::Drawing::Font(
        L"Arial", 9, System::Drawing::FontStyle::Bold,
    ...
    this->ip_input->Margin = System::Windows::Forms::Padding(2);
    ...
    this->netmask_input->Items->AddRange(gcnew cli::array<System::Object ^>(33){
        ...
        L"255.255.254.0", L"255.255.252.0", L"255.255.248.0", L"255.255.240.0",
        L"255.255.224.0", L"255.255.192.0", L"255.255.128.0", L"255.255.0.0",
        L"255.254.0.0", L"255.252.0.0", L"255.248.0.0", L"255.240.0.0",
        L"255.224.0.0", L"255.192.0.0", L"255.128.0.0", L"255.0.0.0",
        L"254.0.0.0", L"252.0.0.0", L"248.0.0.0", L"240.0.0.0", L"224.0.0.0",
        L"192.0.0.0", L"128.0.0.0", L"0.0.0.0"});
    this->netmask_input->Location = System::Drawing::Point(184, 24);
    this->netmask_input->Margin = System::Windows::Forms::Padding(2);
    ...
    this->calculation_button->Margin = System::Windows::Forms::Padding(2);
    ...
    this->wildcard_output->Margin = System::Windows::Forms::Padding(2);
    ...
    //
    this->network_adress_output->Cursor =
        System::Windows::Forms::Cursors::Default;
    this->network_adress_output->Location = System::Drawing::Point(184, 153);
    this->network_adress_output->Margin = System::Windows::Forms::Padding(2);
    ...
    this->label3->Location = System::Drawing::Point(122, 78);
    ...
    this->label4->Text = L"Network address";
    //
    // clear_all
    //
    ...
    this->clear_all->Location = System::Drawing::Point(60, 359);
    this->clear_all->Margin = System::Windows::Forms::Padding(2);
    ...
    this->label6->Location = System::Drawing::Point(73, 198);
    this->label6->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->label6->Name = L"label6";
    this->label6->Size = System::Drawing::Size(110, 15);
    this->label6->TabIndex = 11;
    this->label6->Text = L"First host address";
    //
    // label7
    //
    ...
    this->label7->Location = System::Drawing::Point(70, 237);
    this->label7->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->label7->Name = L"label7";
    this->label7->Size = System::Drawing::Size(110, 15);
    this->label7->TabIndex = 12;
    this->label7->Text = L"Last host address";
    //
    // broadcast_output
    //
    ...
    this->broadcast_output->Margin = System::Windows::Forms::Padding(2);
    ...
    this->last_host_output->Margin = System::Windows::Forms::Padding(2);
    ...
    this->first_host_output->Margin = System::Windows::Forms::Padding(2);
    ...
    this->quan_ip_all_output->Margin = System::Windows::Forms::Padding(2);
    ...
    //
    this->quan_ip_aviable_output->Cursor =
        System::Windows::Forms::Cursors::Default;
    this->quan_ip_aviable_output->Location = System::Drawing::Point(184, 312);
    this->quan_ip_aviable_output->Margin = System::Windows::Forms::Padding(2);
    ...
    this->label8->Location = System::Drawing::Point(36, 277);
    this->label8->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->label8->Name = L"label8";
    this->label8->Size = System::Drawing::Size(143, 15);
    this->label8->TabIndex = 18;
    this->label8->Text = L"Quanity of IP-addresses";
    //
    // label9
    //
    ...
    this->label9->Location = System::Drawing::Point(-3, 314);
    this->label9->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
    this->label9->Name = L"label9";
    this->label9->Size = System::Drawing::Size(186, 15);
    this->label9->TabIndex = 19;
    this->label9->Text = L"Quanity of aviable IP-addresses";
    //
    // MyForm
    //
...
private:
  System::Void calculation_button_Click(System::Object ^ sender,
    ...
    /*String^ network_adress_String = gcnew
    System::String(network_adress(ip_input_string,
    netmask_input_string).c_str());
    String^ wildcard_String = gcnew
    System::String(wildcard(netmask_input_string).c_str());
    ...
    String^ broadcast_String = gcnew
    System::String(broadcast(network_adress_string, wildcard_string).c_str());
    String^ first_host_String = gcnew
    System::String(first_host(network_adress_string,
    netmask_input_string).c_str());
    String^ last_host_String = gcnew System::String(last_host(wildcard_string,
    network_adress_string).c_str());

    string broadcast_string = context.marshal_as<string>(broadcast_String);
    String^ quan_ip_all_String = gcnew System::String(quan_ip(broadcast_string,
    network_adress_string).c_str());

    string quan_ip_all_string = context.marshal_as<string>(quan_ip_all_String);
    String^ quan_ip_aviable_String = gcnew
    System::String(quan_aviable(quan_ip_all_string).c_str());
