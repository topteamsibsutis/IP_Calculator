...
private:
    System::Windows::Forms::Button ^ create_text_file;
...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void)
    {
        ...
        this->netmask_input->Items->AddRange(gcnew cli::array<System::Object ^>(
                33){L"255.255.255.255", L"255.255.255.254", L"255.255.255.252",
        ...
        this->calculation_button->Click += gcnew System::EventHandler(
                this, &MyForm::calculation_button_Click);
        //
        // wildcard_output
        //
        this->wildcard_output->Cursor
                = System::Windows::Forms::Cursors::Default;
        this->wildcard_output->Location = System::Drawing::Point(184, 73);
        this->wildcard_output->Margin
                = System::Windows::Forms::Padding(2, 2, 2, 2);
        ...
        this->network_adress_output->Cursor
                = System::Windows::Forms::Cursors::Default;
        this->network_adress_output->Location
                = System::Drawing::Point(184, 153);
        this->network_adress_output->Margin
                = System::Windows::Forms::Padding(2, 2, 2, 2);
        ...
        this->quan_ip_aviable_output->Cursor
                = System::Windows::Forms::Cursors::Default;
        this->quan_ip_aviable_output->Location
                = System::Drawing::Point(184, 312);
        this->quan_ip_aviable_output->Margin
                = System::Windows::Forms::Padding(2, 2, 2, 2);
        ...
        this->create_text_file->Click += gcnew System::EventHandler(
                this, &MyForm::Create_text_file_Click);
        //
        // MyForm
        //
...
#pragma endregion
private:
    System::Void calculation_button_Click(
            System::Object ^ sender, System::EventArgs ^ e)
    {
        ...
        String ^ first_host_String = gcnew System::String(
                first_host(network_adress_string, netmask_input_string)
                        .c_str());
        ...
        string quan_ip_all_string
                = context.marshal_as<string>(quan_ip_all_String);
        String ^ quan_ip_aviable_String = gcnew System::String(
                quan_aviable(quan_ip_all_string).c_str());
...
private:
    System::Void Create_text_file_Click(
            System::Object ^ sender, System::EventArgs ^ e)
    {
        msclr::interop::marshal_context context;
        string ip_input_string = context.marshal_as<string>(ip_input->Text);
        string netmask_input_string
                = context.marshal_as<string>(netmask_input->Text);
        string wildcard_string
                = context.marshal_as<string>(wildcard_output->Text);
        string broadcast_string
                = context.marshal_as<string>(broadcast_output->Text);
        string network_adress_string
                = context.marshal_as<string>(network_adress_output->Text);
        string first_host_string
                = context.marshal_as<string>(first_host_output->Text);
        string last_host_string
                = context.marshal_as<string>(last_host_output->Text);
        string quan_ip_all_string
                = context.marshal_as<string>(quan_ip_all_output->Text);
        string quan_ip_aviable_string
                = context.marshal_as<string>(quan_ip_aviable_output->Text);
        create_file(
                ip_input_string,
                netmask_input_string,
                wildcard_string,
                broadcast_string,
                network_adress_string,
                first_host_string,
                last_host_string,
                quan_ip_all_string,
                quan_ip_aviable_string);
        System::Windows::Forms::MessageBox::Show(
                "Text file created!",
                "File",
                System::Windows::Forms::MessageBoxButtons::OK,
